...
class PVPanel(Component):
    ...
    def _define_attrbs(self):
        ...
        self.args = {
                 ...
                 'V_mp_ref':data_field('V_mp_ref','Voltage at Max Power (Vmp, V):', 0.0),
                 'I_mp_ref':data_field('I_mp_ref', 'Current at Max Power (Imp, A):', 0.0),
                 'V_oc_ref':data_field('V_oc_ref','Open Circuit Voltage (Voc, V):', 0.0),
                 'I_sc_ref':data_field('I_sc_ref','Short Circuit Current (Isc, A):', 0.0),
